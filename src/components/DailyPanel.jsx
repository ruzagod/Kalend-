        ...
        <div className="daily-panel max-w-4xl mx-auto">
            ...
            <header className="mb-8">
                ...
                <div className="h-3 bg-gray-900/50 rounded-full overflow-hidden mb-8 border border-white/5">
                    <div
                        className="h-full bg-gradient-to-r from-blue-600 to-indigo-500 transition-all duration-700 ease-out shadow-[0_0_15px_rgba(59,130,246,0.4)]"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <section className="glass-panel p-6 rounded-2xl border-yellow-500/10 bg-gradient-to-b from-yellow-900/5 to-transparent">
                    <h3 className="text-xl font-bold text-yellow-400 mb-6 flex items-center gap-2 uppercase tracking-wider drop-shadow-[0_0_5px_rgba(250,204,21,0.5)]">
                        <Star size={24} className="fill-yellow-400" /> Priority
                    </h3>
                    <div className="space-y-4">
                        {priorityTasks.length === 0 && <p className="text-yellow-400/60 text-sm italic text-center py-4">Žádné hořící termíny ⚡</p>}
                ...
                {/* 🟩 Sekce 2: PLÁN DNE (GREEN) */}
                <section className="glass-panel p-6 rounded-2xl border-green-500/10 bg-gradient-to-b from-green-900/5 to-transparent">
                    ...
                    <div className="space-y-3">
                        {activeOtherTasks.length === 0 && <p className="text-green-400/60 text-sm italic text-center py-4">Žádné další úkoly ✨</p>}
                        ...
                        <div
                            ...
                            className="text-green-300/60 text-sm italic p-3 mt-4 text-center border border-dashed border-green-500/20 rounded-xl hover:bg-green-500/10 hover:text-green-200 transition-colors cursor-pointer"
                        >
                            + Rychlý úkol
                        </div>
                    </div>
                ...
                {/* 🟦 Sekce 3: HOTOVO (BLUE) */}
                <section className="glass-panel p-6 rounded-2xl border-blue-500/10 bg-gradient-to-b from-blue-900/5 to-transparent flex flex-col">
                    <h3 className="text-xl font-bold text-blue-400 mb-6 flex items-center gap-2 uppercase tracking-wider drop-shadow-[0_0_5px_rgba(96,165,250,0.5)]">
                        <Circle size={24} /> Hotovo
                    </h3>
                    <div className="space-y-3 opacity-80 hover:opacity-100 transition-opacity">
                        {completedTasksList.length === 0 && <p className="text-blue-400/60 text-sm italic text-center py-4 mt-auto">Zatím nic...</p>}
